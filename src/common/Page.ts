...
export const enum PageEmittedEvents {
   ...
   * {@link https://developer.mozilla.org/en-US/docs/Web/Events/DOM
   * Loaded | DOMContentLoaded } event is dispatched.
   */
...
export class Page extends EventEmitter {
  ...
  /**
   * @remarks Gets the full HTML contents of the page, including the doctype.
   * @returns 
   */
   ...
   * **NOTE** if `runBeforeUnload` is passed as true, a `beforeunload` dialog might be
   * summoned and should be handled manually via page's
   * {@link page.on(<Dialog>) } event.
   * @param options 
   */
  async close(
