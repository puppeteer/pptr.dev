...
This method fetches an element with `selector`, scrolls it into view if needed, and then uses  to click in the center of the element. If there's no element matching `selector`, the method throws an error.
